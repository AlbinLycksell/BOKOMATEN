...
Usage:
  ...
  uv run erase-tenant FIRMA_ID --operator alice@switchboard.se
"""
...
from switchboard.integrations.storage import make_storage
from switchboard.models import Firma
from switchboard.services import audit_service

log = get_logger("switchboard.erase_tenant")
