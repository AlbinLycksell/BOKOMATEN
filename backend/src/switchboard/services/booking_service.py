...
from switchboard.core.time import STOCKHOLM
from switchboard.models import Job, JobStatus, User
...
log = get_logger("switchboard.booking")
...
def book(
    ...
    *,
    ...
    return BookAppointmentResult(
        booking_id=job.id,
        calendar_event_url=f"https://app.switchboard.se/bookings/{job.id}",
